...
from belveb_exchange_client import rest
from belveb_exchange_client.configuration import Configuration
from belveb_exchange_client.exceptions import ApiTypeError, ApiValueError, ApiException
from belveb_exchange_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_rates_get  # this is an instance of the class Endpoint
        api_instance.get_rates_get()  # this invokes api_instance.get_rates_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_rates_get.callable or self.callable in this class
